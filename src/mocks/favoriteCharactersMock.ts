...
const favoriteCharactersMock: ICharacter[] = [
  {
    id: 1011334,
    name: '3-D Man',
    description: '',
    ...
    urls: [
      {
        type: 'detail',
        url: 'http://marvel.com/characters/74/3-d_man?utm_campaign=apiRef&utm_source=76963d34f3de0e22dcfef2ff864296f3',
      },
      {
        type: 'wiki',
        url: 'http://marvel.com/universe/3-D_Man_(Chandler)?utm_campaign=apiRef&utm_source=76963d34f3de0e22dcfef2ff864296f3',
      },
      {
        type: 'comiclink',
        url: 'http://marvel.com/comics/characters/1011334/3-d_man?utm_campaign=apiRef&utm_source=76963d34f3de0e22dcfef2ff864296f3',
      },
    ],
  },
  {
    ...
    urls: [
      {
        type: 'detail',
        url: 'http://marvel.com/characters/76/a-bomb?utm_campaign=apiRef&utm_source=76963d34f3de0e22dcfef2ff864296f3',
      },
      {
        type: 'comiclink',
        url: 'http://marvel.com/comics/characters/1017100/a-bomb_has?utm_campaign=apiRef&utm_source=76963d34f3de0e22dcfef2ff864296f3',
      },
    ],
  },
];

export default favoriteCharactersMock;
